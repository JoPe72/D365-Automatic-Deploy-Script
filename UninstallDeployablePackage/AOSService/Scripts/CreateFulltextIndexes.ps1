...
$commandParameter += " -sqluser `"$($settings.'Database.SqlUser')`""
$commandParameter += " -sqlserver `"$($settings.'Database.DbServer')`""
$commandParameter += " -sqldatabase `"$($settings.'Database.Database')`""
$commandParameter += " -setupmode `"postsync`""

Write-Log "Creating fulltext indexes: $command $commandParameter"

$sqlPwd = Get-KeyVaultSecret -VaultUri $settings.'DataAccess.SqlPwd'
$commandParameter += " -sqlpwd `"$($sqlPwd)`""

Set-Location "$codeFolder\bin"
Start-Process $command $commandParameter -PassThru -Wait -RedirectStandardOutput "$PsScriptRoot\postsync.log" -RedirectStandardError "$PsScriptRoot\postsync.error.log"

$dbSyncOutput = "$PsScriptRoot\postsync.log"
Write-Log $dbSyncOutput

$dbSyncError = Get-Content "$PsScriptRoot\postsync.error.log"
if ($dbSyncError -ne $null) {
    throw $dbSyncError
}

Write-Log "Indexes created."
# SIG # Begin signature block
# MIIkCAYJKoZIhvcNAQcCoIIj+TCCI/UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAt9DkNEgO8TNUs
# nRjZNlCWJkkXd+etryh+wRXzMFP6F6CCDYIwggYAMIID6KADAgECAhMzAAAAww6b
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOb+Ibzu
# S0RPU1r1KtdSXWU8U9yVjhp1H87XPxQUW8pHMGIGCisGAQQBgjcCAQwxVDBSoDSA
# MgBDAHIAZQBhAHQAZQBGAHUAbABsAHQAZQB4AHQASQBuAGQAZQB4AGUAcwAuAHAA
# cwAxoRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASC
# AQChv1R4vKWg9yewZGZq2dLXWybtK3XQlez180x2Rb7gp4dzfI+h4bfqsTF5DqIl
# gaCvZYXw4B3JJe7IxyRvW3v3AfhMbUMsuv3zpSOu5sfEaXhhzYKb0J3ciK2EkFMy
# k80Yc7P5kDKh+yh4GIMzWnMf/nuYGztT2FvnEpgBK+SkwoLn2UoA07dmzXw2XK9l
# yT3ybo0YAKmXYkKmo0Y0fTIxEw2jBGk9IiLzpEnT2XUrcLZeeRlOuQ39uT/aPTFP
# mO/K3Hf0GAerDG9rBq7BZ4dfkiGjnKbqh0Nhkr7ZmncWiSCCdvK+fligmgT2+jpR
# jhj+ZJocfm7fRsegIsyzXc3GoYITRjCCE0IGCisGAQQBgjcDAwExghMyMIITLgYJ
...
# BQAEIOGeW10Gu9XTSNOcSRpZnZ8ytvHBkO0DvaO0wwqsZyVwAgZasq/AD6MYEzIw
# MTgwMzI1MjEwNTU1LjMwOFowBwIBAYACAfSggbekgbQwgbExCzAJBgNVBAYTAlVT
...
# MSIEIFNxOmHfqASnhHd6NliqxIulEdJT5LqGHeU/nAi4V5YQMIHiBgsqhkiG9w0B
...
# tzAWBBTcFdd75IjHNZEZ4MTLKywSp0RTCzANBgkqhkiG9w0BAQsFAASCAQAMgmcZ
# A+vc9pg3+yT/g4uO8SZxF/yaIuNJi//XzTp0rbURISVwFDkAX1bkjCmB2Y/ZPBuE
# qL1SQgvG/cJi/aCy6+LDiWmv4gujhs8cIE3FKjYY5tzYD9Ojk8c3/j1T+sGbUf0Q
# 2umDjOEYaSJa29GNNakorhpwChWkD6GDBmZP3pSGfss3+RpbH2bpy/YF+5+Oaw6M
# 37uPDnDi3+VkNycbLfDbp4EorFwMj98gZ1bN6j/0HEUlXUOFYRLGDnHljxMlPLDS
# kfS09Ghxif+VhdB4N3LYe4K1Y1iiYJoMFb40J6CPzSHXUs5RNwLiKC2IlarcNjoe
# /F450QWwX+FGkhpW
